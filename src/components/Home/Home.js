        ...
        <div>
            ...
            <section className="md:flex w-4/5 mx-auto mt-20">
                <div className="w-2/3 mt-24">
                    ...
                    <button onClick={reviewBtnHandle} className="mx-10 my-6 py-3 rounded-lg hover:bg-blue-200 duration-200 ease-in text-blue-700 px-6 bg-blue-100">REVIEWS</button>
                </div>
                <div className="">
