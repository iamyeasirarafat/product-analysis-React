...
const Nav = () => {
    return (
        <nav className=" justify-center md:flex mt-6">
            <ul className="flex ">
             ...
             return {color: isActive ? "rgb(244 114 182)" : "",};
                ...
                <li className="mr-2 hidden md:block duration-200 ease-in font-semibold px-4 pb-1 hover:text-pink-400 hover:border-pink-400 border-b-2"><NavLink style={({ isActive }) => {
             return {color: isActive ? "rgb(244 114 182)" : "",};
